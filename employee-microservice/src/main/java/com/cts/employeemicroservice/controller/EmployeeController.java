...
public class EmployeeController {
	...
	public ResponseEntity<?> viewTopOffers(@RequestHeader(name = "Authorization", required = true) String token, @PathVariable("id") int id) throws InvalidUserException, MicroserviceException {
